...
class CategoryCreateSheet extends StatefulWidget {
  ...
  const CategoryCreateSheet(this.categories, {super.key});
  ...
  static Future<String?> show(
    ...
    return showModalBottomSheet<String>(
      ...
      showDragHandle: true,
      builder: (context) => CategoryCreateSheet(categories),
    );
  }

  @override
  State<CategoryCreateSheet> createState() => _CategoryCreateModalState();
}

class _CategoryCreateModalState extends State<CategoryCreateSheet> {
